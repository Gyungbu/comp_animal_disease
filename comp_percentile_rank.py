...
if len(sys.argv) < 2:
    ...
    print("Example: python comp_percentile_rank.py \"/home/kbkim/comp_animal_disease/input/mirror_output_dog_1340.csv\"")
    print("Example: python comp_percentile_rank.py \"/home/kbkim/comp_animal_disease/input/mirror_output_cat_1409.csv\"")
    sys.exit(1)
